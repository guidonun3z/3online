...
namespace chat_winforms_1
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void btn_3online1_Load(object sender, EventArgs e)
        {
            //btn_3online1.marcar_button("O".ToString());
        }
        private void btn_3online1_Click(object sender, EventArgs e, string simbol)
        {
            btn_3online1.marcar_button("O".ToString());
        }
    }
